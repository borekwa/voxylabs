...
(function() {
  var AdminView, DislikedVideosView, ExperimentView, HomeView, LikedVideosView, Router, SendSmsView, SpeakingSurveyView, UploadVideoView, Video, VideoCollection, VideoCollectionView, VideoCommentView, VideoExperimentView, VideoFeedbackView, VideoModelResultsView, VideoModelView, VideoResultsCollectionView, router, _ref, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  Router = (function(_super) {
    ...
    Router.prototype.sendSms = function() {
      var sendSmsView;
      return sendSmsView = new SendSmsView();
    };
  ...
  AdminView = (function(_super) {
    ...
    AdminView.prototype.goToLingPing = function(e) {
      e.preventDefault();
      return router.navigate("admin/lingping", true);
    };
  ...
  SendSmsView = (function(_super) {
    __extends(SendSmsView, _super);

    function SendSmsView() {
      _ref17 = SendSmsView.__super__.constructor.apply(this, arguments);
      return _ref17;
    }

    SendSmsView.prototype.el = "#container";

    SendSmsView.prototype.template = $("#send-sms-template").html();

    SendSmsView.prototype.initialize = function() {
      return this.render();
    };
